...
}(this,"undefined"!=typeof Meteor&&"undefined"!=typeof Package),$(function(){Holder.addTheme("gray",{bg:"#757575",fg:"rgba(255,255,255,.7)",font:"Helvetica",fontweight:"normal"})}),$(function(){$(".search-input input").blur(function(){$(this).val()?$(this).find("~ label, ~ span:nth-of-type(n+3)").addClass("not-empty"):$(this).find("~ label, ~ span:nth-of-type(n+3)").removeClass("not-empty")}),$(".search-input input ~ span:nth-of-type(4)").click(function(){$(".search-input input").val(""),$(".search-input input").find("~ label, ~ span:nth-of-type(n+3)").removeClass("not-empty")})}),$(document).ready(function(){var a=266,b="...",c="READ MORE",d="READ LESS";$(".more").each(function(){var d=$(this).html();if(d.length>a){var e=d.substr(0,a),f=d.substr(a,d.length-a),g=e+'<span class="moreellipses">'+b+'&nbsp;</span><span class="morecontent"><span>'+f+'</span>&nbsp;&nbsp;<a href="" class="morelink">'+c+"</a></span>";$(this).html(g)}}),$(".morelink").click(function(){return $(this).hasClass("less")?($(this).removeClass("less"),$(this).html(c)):($(this).addClass("less"),$(this).html(d)),$(this).parent().prev().toggle(),$(this).prev().toggle(),!1})}),$(function(){var a=!0;$("#collapse-init").click(function(){a?(a=!1,$(".collapse").collapse("show"),$(".card-header").attr("data-toggle",""),$(this).html('Hide all <span class="material-icons">&#xE5CE;</span>')):(a=!0,$(".collapse").collapse("hide"),$(".card-header").attr("data-toggle","collapse"),$(this).html('View all <span class="material-icons">&#xE5CF;</span>'))}),$("#accordion").on("show.bs.collapse",function(){a&&$("#accordion .in").collapse("hide")}),$("#accordion2").on("show.bs.collapse",function(){a&&$("#accordion2 .in").collapse("hide")})});